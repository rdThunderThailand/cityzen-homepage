    ...
    <header className="sticky top-0 z-40 border-b bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80">
      <div className="container flex h-14 lg:h-16 items-center justify-between gap-4">
        ...
        <Link to="/" className="flex items-center gap-0.5 shrink-0">
          <img src={cityzenLogo} alt="Cityzen" className="h-20 w-20 lg:h-[90px] lg:w-[90px] object-contain self-center translate-y-3" />
          <span className="text-lg lg:text-xl font-extrabold text-primary -ml-3">CityZen</span>
        </Link>
